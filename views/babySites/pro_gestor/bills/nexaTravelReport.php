...
$backgroundImage1 = 'images/nexaTravel.jpg'; // Absolute or relative path
...
<p style="color: black; font-size: 25px; padding-top: -23px; padding-left: 160px; font-weight: bold;">' . $_POST['tmc'] . '</p>
<p style="color: black; font-size: 18px; padding-top: -30px; padding-left: 114px; font-weight: bold;">' . $_POST['tmc'] . '</p>
...
$html .= '
<p style="position: absolute; font-size: 12px; top: 210.5mm; left: 185mm;" />' . $_POST['subtotal'] . '</p>
<p style="position: absolute; font-size: 12px; top: 219.5mm; left: 185mm;" />' . $_POST['tax'] . '</p>
<p style="position: absolute; font-size: 12px; top: 228.5mm; left: 185mm;" />' . $_POST['total'] . '</p>
';
