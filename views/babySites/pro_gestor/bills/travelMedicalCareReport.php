...
if ($_POST['currency'] === 'euro') {
    $backgroundImage1 = 'images/TMC_euro.jpg'; // Euro background
} else {
    $backgroundImage1 = 'images/TMC_dollar.jpg'; // Dollar background
}
...
<p style="position: absolute; font-size: 25px; top: 11mm; left: 185mm; width: 70px; font-weight: bold;">' . $_POST['tmc'] . '</p>
