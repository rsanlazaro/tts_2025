...
<main class="dashboard">
        ...
        <div class="lateral">
            ...
            <div href="#" class="icon-container">
                ...
                <div class="dropdown">
                    ...
                    <a class="dropdown-item active" href="#">Listado Sort_GES</a>
    ...
    <div class="content" id="content">
        ...
        <div class="sortGESC-body">
            <div class="general-info">
                <div class="text">
                    <h3>Maria de las Flores Vasquez</h3>
                    <div class="info-pdf">
                        <div class="info-pdf-text">
                            <p>Calle de la gloria altiva 36 lote 5</p>
                            <p>260002 - Miguel Hidalgo - México</p>
                            <p>+52 5522425 52125</p>
                            <p>Status: <span>Iniciales</span></p>
                            <p class="ip">IP: Ronaldo Fenomeno</p>
                        </div>
                        <div>
                            <a href="#"><img src="../../../build/img/icons/pdf-icon.webp" alt="pdf icon"></a>
                        </div>
                    </div>
                </div>
                <div class="img">
                    <img src="../../../build/img/testImg/profilepic.webp" alt="profile picture">
                </div>
            </div>
            <div class="nav-section">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="alta-tab" data-bs-toggle="tab" data-bs-target="#alta" type="button" role="tab" aria-controls="alta" aria-selected="true">Alta Gesca <img src="../../../build/img/icons/GES-alta.webp" alt="icon"></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="checklist-tab" data-bs-toggle="tab" data-bs-target="#checklist" type="button" role="tab" aria-controls="checklist" aria-selected="false">Check List <img src="../../../build/img/icons/GES-checklist.webp" alt="icon"></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="seguro-tab" data-bs-toggle="tab" data-bs-target="#seguro" type="button" role="tab" aria-controls="seguro" aria-selected="false">Seguro Med <img src="../../../build/img/icons/GES-seguro.webp" alt="icon"></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="psico-tab" data-bs-toggle="tab" data-bs-target="#psico" type="button" role="tab" aria-controls="psico" aria-selected="false">Psico Social <img src="../../../build/img/icons/GES-social.webp" alt="icon"></button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="cita-tab" data-bs-toggle="tab" data-bs-target="#cita" type="button" role="tab" aria-controls="cita" aria-selected="false">Cita Previa <img src="../../../build/img/icons/GES-cita.webp" alt="icon"></button>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Registro Inicial/Datos Personales
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body register">
                                        <div class="first-column">
                                            ...
                                            <div class="form-group">
                                                <label for="scheme">Esquema ofrecido:</label>
                                                <input type="text" id="scheme" name="scheme">
                                            </div>
                                            <div class="form-group">
                                                <label for="tel-1">Tel. 1:</label>
                                                <input type="number" id="tel-1" name="tel-1">
                                            </div>
                                            <div class="form-group">
                                                <label for="tel-2">Tel. 2:</label>
                                                <input type="number" id="tel-2" name="tel-2">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="civil-state" name="civil-state">
                                            </div>
                                        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        Datos de Salud Iniciales de Requisitos al Programa
                                    </button>
                                </h2>
                    ...
                    <div class="tab-pane fade" id="psico" role="tabpanel" aria-labelledby="psico-tab">
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
